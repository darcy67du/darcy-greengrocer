...
```php
define('DB_HOST', 'sql305.infinityfree.com');  // your MySQL host from control panel
define('DB_USER', 'if0_xxxxxxxx');              // your MySQL username
define('DB_PASS', 'your_password');             // your MySQL password
define('DB_NAME', 'if0_xxxxxxxx_greengrocer'); // your database name
define('SITE_URL', 'http://yourdomain.infinityfreeapp.com'); // your domain
```
