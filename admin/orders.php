    ...
    <table class="admin-table" style="margin-bottom:20px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $item['unit_type']==='kg' ? number_format((float)$item['quantity'], 1, '.', ',').' kg' : (int)$item['quantity'].' unit(s)' ?></td>
                <td>RWF <?= number_format((float)$item['price_at_purchase'], 0, '.', ',') ?></td>
                <td><strong>RWF <?= number_format((float)($item['price_at_purchase']*$item['quantity']), 0, '.', ',') ?></strong></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
        <tfoot>
            <tr><td colspan="3" style="text-align:right;font-weight:700;">Total:</td>
            <td style="font-weight:700;color:var(--green-mid);">RWF <?= number_format((float)$viewOrder['total_price'], 0, '.', ',') ?></td></tr>
        </tfoot>
    </table>
    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>RWF <?= number_format((float)$o['total_price'], 0, '.', ',') ?></td>
