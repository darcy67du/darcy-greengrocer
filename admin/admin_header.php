...
<aside class="admin-sidebar">
    ...
    <a href="/admin/index.php"    class="<?= $cur==='index.php'    ?'active':'' ?>">📊 Dashboard</a>
    <a href="/admin/products.php" class="<?= $cur==='products.php' ?'active':'' ?>">🛒 Products</a>
    <a href="/admin/orders.php"   class="<?= $cur==='orders.php'   ?'active':'' ?>">📦 Orders</a>
    <a href="/admin/users.php"    class="<?= $cur==='users.php'    ?'active':'' ?>">👤 Customers</a>
    <a href="/index.php" style="margin-top:auto;">← Back to Shop</a>
