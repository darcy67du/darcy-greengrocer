    ...
    <div class="products-grid">
        ...
        <div class="product-card" data-category="<?= htmlspecialchars($p['category']) ?>">
            ...
            <div class="product-body">
                ...
                <?php if ($low): ?>
                    <span class="product-stock-low">⚠ Only <?= number_format((float)$p['stock'], $isKg ? 1 : 0, '.', ',') ?> <?= $isKg ? 'kg' : 'units' ?> left</span>
                <?php endif; ?>
            </div>
            <div class="product-footer">
                <div>
                    <span class="product-price">RWF <?= number_format((float)$p['price'], 0, '.', ',') ?></span>
